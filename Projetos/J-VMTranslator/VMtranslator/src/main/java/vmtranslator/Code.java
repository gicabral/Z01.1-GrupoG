...
public class Code {
    ...
    public void writeArithmetic(String command) {
        ...
        if(command.equals("add")) {
            ...
            commands.add("movw %S, (%A)"); // SP = penultima
            commands.add("movw %A, %D");
            commands.add("incw %D");
            commands.add("leaw $SP,%A");
            ...
            commands.add("movw (%A),%D");
            commands.add("negw %D");
            commands.add("movw %D, (%A)"); // SP = penultima
            commands.add("movw %A, %D");
            commands.add("incw %D");
            commands.add("leaw $SP,%A");
            commands.add("movw %D,(%A)");
            ...
            commands.add("leaw $VERDADE-"+uuid +",%A");
            commands.add("je %S");
            commands.add("nop");
            ...
            commands.add("leaw $SP,%A");
            commands.add("movw %D,(%A)");
            commands.add("leaw $FINISH-"+uuid +",%A");
            commands.add("jmp");
            commands.add("nop");

            commands.add("VERDADE-"+uuid +":");
    ...
    public void writePushPop(Parser.CommandType command, String segment, Integer index) {
        ...
        if(command == Parser.CommandType.C_POP) {
            ...
            if (segment.equals("constant")) {
            	...
            	Error.error("Não faz sentido POP com argument");
            ...
            if (segment.equals("constant")) {
                ...
                Error.error("Não faz sentido PUSH com argument");
                ...
                Error.error("Não faz sentido PUSH com static");
